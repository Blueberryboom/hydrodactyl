...
class UpdateCustomNavigationRequest extends GetSettingsRequest
{
        ...
        return [
            ...
            'app:custom_nav_items.*.url' => [
                ...
                function (string $attribute, mixed $value, Closure $fail): void {
                    ...
                    if (str_starts_with($value, '/') || (in_array($scheme, ['http', 'https'], true) && filter_var($value, FILTER_VALIDATE_URL) !== false)) {
                        return;
                    }
    ...
    public function normalize(?array $only = null): array
    {
        ...
        return ['app:custom_nav_items' => json_encode($items)];
    }
}
